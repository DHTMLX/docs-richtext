...
- Create a ***DataSample.js*** file and describe the methods you want to use while working with the RichText. In the example below `updateMarkdown()` and `updateHTML()` methods are added for updating the the content of the RichText editor:

~~~jsx title="DataSample.js"
