...
title: Events 概述
description: 您可以在 DHTMLX JavaScript RichText 库的文档中找到 JavaScript RichText 的 Events 概述。浏览开发者指南和 API 参考，试用代码示例和在线演示，并下载 DHTMLX RichText 的免费 30 天评估版本。
---

# Events 概述

本页列出了 DHTMLX RichText 编辑器触发的所有 events。  
您可以使用这些 events 来扩展功能、跟踪用户交互或触发自定义行为。
