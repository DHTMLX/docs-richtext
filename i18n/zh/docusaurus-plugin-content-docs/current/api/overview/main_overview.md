...
title: API 概览
description: 您可以在 DHTMLX JavaScript RichText 库的文档中查看 JavaScript RichText 的 API 概览。浏览开发者指南和 API 参考，尝试代码示例和在线演示，并下载 DHTMLX RichText 的免费 30 天评估版本。
---

# API 概览 {#api-overview}

## RichText 构造函数 {#richtextconstructor}
...
- 一个配置对象（[查看属性](api/overview/properties_overview.md)）

## RichText 方法 {#richtextmethods}
