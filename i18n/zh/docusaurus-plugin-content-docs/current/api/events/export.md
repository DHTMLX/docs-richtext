...
title: export 事件
description: 您可以在 DHTMLX JavaScript RichText 库的文档中了解 export 事件。浏览开发指南和 API 参考，查看代码示例和在线演示，并下载免费的 30 天评估版 DHTMLX RichText。
---
...
@short: 在菜单栏中按下"导出"选项或通过 Event Bus 方法触发后触发
