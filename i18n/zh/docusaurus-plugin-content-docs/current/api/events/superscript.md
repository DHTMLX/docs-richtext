...
description: 您可以在 DHTMLX JavaScript RichText 库的文档中了解 superscript 事件。浏览开发指南和 API 参考，查看代码示例和在线演示，并下载 DHTMLX RichText 的免费 30 天评估版本。
---
...
@short: 当点击菜单栏/工具栏中的"上标"按钮或通过 Event Bus 方法触发时触发
