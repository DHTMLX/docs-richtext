...
description: 您可以在 DHTMLX JavaScript RichText 库的文档中了解 superscript 事件。浏览开发者指南和 API 参考，查看代码示例和在线演示，并下载 DHTMLX RichText 的免费 30 天评估版本。
---
...
@short: 当在 menubar/toolbar 中按下"Superscript"按钮或通过 Event Bus 方法调用时触发
