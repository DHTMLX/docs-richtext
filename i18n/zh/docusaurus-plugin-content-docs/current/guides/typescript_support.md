...
title: TypeScript 支持
description: 您可以在文档中了解如何将 TypeScript 与 DHTMLX JavaScript RichText 库结合使用。浏览开发者指南和 API 参考，试用代码示例和在线演示，并下载 DHTMLX RichText 的免费 30 天评估版本。
---
...
:::note
在 <a href="https://snippet.dhtmlx.com/ziynafp7?tag=richtext" target="_blank">Snippet Tool</a> 中试用编辑器。
:::

## TypeScript 的优势

将 TypeScript 与 DHTMLX RichText 结合使用，您可以获得：

- 类型安全——编译器在构建时即可捕获配置属性和方法参数的误用
- 自动补全——IDE 在您输入时自动提示有效的属性名、方法签名和值类型
