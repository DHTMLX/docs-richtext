...
**相关示例：** [RichText. 每个触发器的自定义下拉模板](https://snippet.dhtmlx.com/0p3bbnhz?tag=richtext)
...
**相关示例：** [RichText. Emoji 自动补全](https://snippet.dhtmlx.com/g5z1d868?tag=richtext)
...
**相关示例：** [RichText. 斜杠命令](https://snippet.dhtmlx.com/e0mrmyam?tag=richtext)
