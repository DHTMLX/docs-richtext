...
Die RichText-Komponente ist einsatzbereit. Angular rendert den Editor mit Daten, wenn das Element `<richtext/>` eingebunden wird. Eine vollständige Liste der Konfigurationsoptionen finden Sie in der [RichText API-Übersicht](api/overview/main_overview.md).
