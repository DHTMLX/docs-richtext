...
@short: Optional. Aktiviert die obere menubar von RichText
...
**Verwandtes Beispiel:** [RichText. Initialisierung mit menubar](https://snippet.dhtmlx.com/tjryzka7?tag=richtext)
