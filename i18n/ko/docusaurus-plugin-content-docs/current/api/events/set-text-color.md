...
description: DHTMLX JavaScript RichText 라이브러리의 set-text-color 이벤트에 대한 문서를 확인할 수 있습니다. 개발자 가이드와 API 레퍼런스를 살펴보고, 코드 예제와 라이브 데모를 체험해 보세요. DHTMLX RichText의 무료 30일 평가판도 다운로드할 수 있습니다.
---
...
**set-text-color** 이벤트의 callback은 다음 매개변수를 가진 객체를 받을 수 있습니다:
