...
title: 이벤트 개요
description: DHTMLX JavaScript RichText 라이브러리 문서에서 JavaScript RichText의 이벤트 개요를 확인할 수 있습니다. 개발자 가이드와 API 레퍼런스를 살펴보고, 코드 예제와 라이브 데모를 체험해 보세요. 또한 DHTMLX RichText의 30일 무료 평가판을 다운로드할 수 있습니다.
---

# 이벤트 개요 {#events-overview}

이 페이지에는 DHTMLX RichText 에디터가 발생시키는 모든 이벤트가 나열되어 있습니다.  
이러한 이벤트를 사용하여 기능을 확장하거나, 사용자 상호작용을 추적하거나, 커스텀 동작을 트리거할 수 있습니다.
