...
title: 속성 개요
description: DHTMLX JavaScript RichText 라이브러리 문서에서 JavaScript RichText의 속성 개요를 확인할 수 있습니다. 개발자 가이드와 API 레퍼런스를 탐색하고, 코드 예제와 라이브 데모를 체험해 보세요. DHTMLX RichText의 무료 30일 평가판도 다운로드할 수 있습니다.
---

# 속성 개요

이 페이지에는 DHTMLX RichText 에디터를 초기화할 때 사용할 수 있는 모든 구성 속성이 나열되어 있습니다.  
이 속성들은 에디터의 레이아웃, 툴바, 값, 현지화 및 기타 측면을 제어하는 데 도움이 됩니다.
