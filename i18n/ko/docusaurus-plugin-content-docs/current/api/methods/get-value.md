...
title: getValue 메서드
description: DHTMLX JavaScript RichText 라이브러리 문서에서 getValue 메서드에 대해 알아볼 수 있습니다. 개발자 가이드와 API 레퍼런스를 살펴보고, 코드 예제와 라이브 데모를 직접 실행해 보며, DHTMLX RichText의 무료 30일 평가판을 다운로드할 수 있습니다.
---
...
- `encoder` - (선택) RichText의 콘텐츠를 커스텀 형식으로 인코딩하는 데 사용되는 파서. 다음 형식을 사용할 수 있습니다: `html` (기본값) 및 `text`
