...
- Настраиваемая [`toolbar`](api/config/toolbar.md) со встроенными и пользовательскими кнопками

- Статическая [`menubar`](api/config/menubar.md), которую можно показать или скрыть
...
![Строка меню](/img/richtext/menubar.png)
</div>
...
<div className="img_border">
![Панель инструментов](/img/richtext/toolbar.png)
</div>
...
<div className="img_border">
![Формат HTML](/img/richtext/html_format.png)
</div>

#### Текстовый формат {#text-format}

<div className="img_border">
![Текстовый формат](/img/richtext/text_format.png)
</div>
...
<div className="img_border">
![Сочетания клавиш](/img/richtext/shortcut_reference.png)
</div>
