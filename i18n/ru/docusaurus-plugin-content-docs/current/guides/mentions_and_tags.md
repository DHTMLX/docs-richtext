...
description: 'Узнайте, как настроить @упоминания, #теги и пользовательские триггеры выпадающего списка в DHTMLX RichText. Изучите руководства для разработчиков и справочник API, попробуйте примеры кода и живые демо, загрузите бесплатную 30-дневную ознакомительную версию DHTMLX RichText.'
---
...
Три события предоставляют доступ к жизненному циклу выпадающего списка через Event Bus:
...
**Связанный пример:** [RichText. Пользовательский шаблон выпадающего списка для каждого триггера](https://snippet.dhtmlx.com/0p3bbnhz?tag=richtext)
...
**Связанный пример:** [RichText. Автодополнение эмодзи](https://snippet.dhtmlx.com/g5z1d868?tag=richtext)
...
**Связанный пример:** [RichText. Slash-команды](https://snippet.dhtmlx.com/e0mrmyam?tag=richtext)

## Связанный API {#related-api}
