...
title: Локализация
description: Вы можете узнать о локализации в документации библиотеки DHTMLX JavaScript RichText. Изучайте руководства разработчика и справочник АПИ, пробуйте примеры кода и живые демо, и загружайте бесплатную 30-дневную ознакомительную версию DHTMLX RichText.
---
...
const en = {
    richtext: {
        ...
        // выпадающий список стилей блоков
        Heading: "Heading",
        Quote: "Quote",
        Paragraph: "Paragraph",
...
Создайте объект локали (или измените встроенный) с переводами всех надписей интерфейса. Примените локаль при инициализации или переключите её во время работы, как показано ниже.

### Применение локали при инициализации {#apply-the-locale-at-initialization}
...
### Переключение локали во время работы {#switch-the-locale-at-runtime}
...
Пример ниже демонстрирует переключение между несколькими локалями RichText:
